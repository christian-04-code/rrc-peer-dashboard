...
export const EIA_MACRO_SOURCE_REGISTRY: EiaSourceDefinition[] = [
  ...
  {
    id: "steo-lng-exports-forecast",
    name: "STEO LNG Gross Exports Forecast",
    category: "forecast",
    eiaProduct: "Short-Term Energy Outlook",
    route: EIA_ROUTES.steo,
    seriesId: EIA_STEO_SERIES.lngExportsForecast,
    ingestionType: "api_steo",
    updateFrequency: "monthly",
    freshnessKind: "snapshot",
    geographicScope: "United States",
    ...
    rangeDrivers: ["lng_demand"],
    verified: true,
    description: "EIA's forward LNG export volume projection (billion cubic feet per day). Confirmed as the LNG-specific series (seriesId NGEXPUS_LNG) -- distinct from EIA's separate NGEXPUS ('Natural Gas Total Gross Exports'), which combines pipeline and LNG exports and is not used here to avoid mislabeling a broader figure as LNG-specific."
  },
  {
    id: "steo-total-consumption-forecast",
    name: "STEO Total Natural Gas Consumption Forecast",
    category: "forecast",
    eiaProduct: "Short-Term Energy Outlook",
    route: EIA_ROUTES.steo,
    seriesId: EIA_STEO_SERIES.totalConsumptionForecast,
    ingestionType: "api_steo",
    updateFrequency: "monthly",
    freshnessKind: "snapshot",
    geographicScope: "United States",
    ...
    rangeDrivers: ["us_gas_supply"],
    verified: true,
    description: "EIA's forward total U.S. gas consumption projection -- broad demand-side context alongside the sector-specific forecasts below."
  },
  {
    id: "steo-commercial-consumption-forecast",
    name: "STEO Commercial Sector Consumption Forecast",
    category: "forecast",
    eiaProduct: "Short-Term Energy Outlook",
    route: EIA_ROUTES.steo,
    seriesId: EIA_STEO_SERIES.commercialConsumptionForecast,
    ingestionType: "api_steo",
    updateFrequency: "monthly",
    freshnessKind: "snapshot",
    geographicScope: "United States",
    ...
    rangeDrivers: [],
    verified: true,
    description: "Seasonal-demand context, secondary to power/industrial for Range."
  },
  {
    id: "steo-residential-consumption-forecast",
    name: "STEO Residential Sector Consumption Forecast",
    category: "forecast",
    eiaProduct: "Short-Term Energy Outlook",
    route: EIA_ROUTES.steo,
    seriesId: EIA_STEO_SERIES.residentialConsumptionForecast,
    ingestionType: "api_steo",
    updateFrequency: "monthly",
    freshnessKind: "snapshot",
    geographicScope: "United States",
  ...
  {
    id: "steo-industrial-consumption-forecast",
    name: "STEO Industrial Sector Consumption Forecast",
    category: "forecast",
    eiaProduct: "Short-Term Energy Outlook",
    route: EIA_ROUTES.steo,
    seriesId: EIA_STEO_SERIES.industrialConsumptionForecast,
    ingestionType: "api_steo",
    updateFrequency: "monthly",
    freshnessKind: "snapshot",
    geographicScope: "United States",
    ...
    verified: true,
    description: "EIA's forward industrial gas demand projection -- a core Range driver (reshoring/manufacturing demand effects on the gas balance)."
  }
];
