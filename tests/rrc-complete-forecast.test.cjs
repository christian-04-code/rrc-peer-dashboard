...
test("complete RRC scenario uses filing-backed Q1 2026 anchors", () => {
  ...
  // Cash G&A now uses the reported Q1 2026 cash-only $/Mcfe rate (excludes stock-based
  // compensation), matching the canonical financials-quarterly.ts dataset, instead of the
  // superseded flat $45.351mm total-G&A figure.
