...
test("HomeDashboard recomputes the live share price per selected ticker and wires it through getOverviewSummaryCards using Finnhub", () => {
  ...
  assert.match(source, /}, \[finnhubQuotes\.data, ticker\]\)/);
